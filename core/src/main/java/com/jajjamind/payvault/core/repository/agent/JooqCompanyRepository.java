...
//region Begin Code
/*
This file has been generated by Jooqify.groovy [Sun Feb 21 03:53:04 EAT 2021]
*/
...
public class JooqCompanyRepository implements QueryResultPicker{
    ...
    public static final String FIELD_NATURE_OF_BUSINSESS = "natureOfBusinsess";
    ...
    public static final String FIELD_CONTAC_ID_TYPE = "contacIdType";
    ...
    private final Field<String> natureOfBusinsess = DSL.field("tc.nature_of_business", String.class);
    ...
    private final Field<String> contacIdType = DSL.field("tc.contact_identification", String.class);
    ...
    private void initFilterer(){
        jooqFilter = new JooqFilter()
                .fields(
                        ...
                        dbField(natureOfBusinsess, FIELD_NATURE_OF_BUSINSESS),
                        ...
                        dbField(contacIdType, FIELD_CONTAC_ID_TYPE),
    ...
    public static class Result{
        ...
        private String natureOfBusinsess;
        private String physicalAddress;
        private String tinNumber;
        private String contactPerson;
        private String contacIdType;
    ...
    public String getAllFields(){
        ...
        builder.append(",");
        builder.append(FIELD_NATURE_OF_BUSINSESS);
        builder.append(",");
        ...
        builder.append(",");
        builder.append(FIELD_CONTAC_ID_TYPE);
        builder.append(",");
