...
public abstract class BaseTestClass {
    ...
    private static final String  ADMIN_USERNAME = "john";
    ...
    public static RequestSpecification getDefaultRequestSpecification(boolean isAdmin){ ;
        ...
        final String bearerToken = response.jsonPath().getString("token");

//        //Remove username and password headers and create new spec
//        RequestSpecification bearerTokenSpec = new RequestSpecBuilder()
//                .addHeader("Authorizaton","")
//                .setPort(PORT)
//                .build();
